...
using TechChallengeBuscaId.RabbitMqEvents;
...
builder.Services.Configure<TechChallengeBuscaId.RabbitMqEvents.RabbitMqSettings>(configuration.GetSection("RabbitMq"));
builder.Services.AddSingleton<RabbitMqEventConsumer>();

//ApplyMigrationsIfNeeded(app);

var counter = Metrics.CreateCounter("TechChallengeBuyscaId", "Counts request to the metrics api endpoint",
