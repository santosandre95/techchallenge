...
using System.Text;
using TechChallengeUpdate.EventProcess;

namespace TechChallengeUpdate.RabbitMqClient
{
    public class RabbitMqConsumer : BackgroundService
    {
        ...
        public RabbitMqConsumer(IConfiguration configuration)
        {
            ...
            _channel.QueueBind(queue: _nomeFila, exchange: "trigger", routingKey: "Update_fila");
        }
