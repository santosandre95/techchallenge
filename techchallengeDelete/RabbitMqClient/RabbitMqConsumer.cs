...
using System.Text;
using TechChallengeDelete.EventProcess;

namespace TechChallengeDelete.RabbitMqClient
{
    public class RabbitMqConsumer : BackgroundService
    {
        ...
        public RabbitMqConsumer(IConfiguration configuration)
        {
            ...
            _channel.QueueBind(queue: _nomeFila, exchange: "trigger", routingKey: "Delete_fila");
        }
