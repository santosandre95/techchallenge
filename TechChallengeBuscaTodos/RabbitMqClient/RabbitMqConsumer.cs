...
using System.Text;
using TechChallengeBuscaTodos.EventProcess;

namespace TechChallengeBuscaTodos.RabbitMqClient
{
    public class RabbitMqConsumer : BackgroundService
    {
        ...
        public RabbitMqConsumer(IConfiguration configuration)
        {
            ...
            _channel.QueueBind(queue: _nomeFila, exchange: "trigger", routingKey: "buscaTodos_fila");
        }
